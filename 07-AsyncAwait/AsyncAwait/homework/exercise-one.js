...
args.forEach(function(arg){
 ...
 async function problemA () {
  ...
  // AsyncAwait version
 let result = await   promisifiedReadFile('poem-one/stanza-01.txt')
 blue(result)
...
async function problemB () {
  ...
  // AsyncAwait version
let result1  = await promisifiedReadFile('poem-one/stanza-02.txt')
let result2  = await promisifiedReadFile('poem-one/stanza-03.txt')
blue(result1)
blue(result2)
}
...
async function problemD () {
  ...
  // AsyncAwait version
  try {
    let result  = await promisifiedReadFile('poem-one/wrong-file-name.txt')
    blue(result)
  } catch (error) {
    magenta(error)
...
async function problemE () {
  ...
  // AsyncAwait version
  try {
    let result1  = await promisifiedReadFile('poem-one/stanza-03.txt')
    blue(result1)
    let result2  = await promisifiedReadFile('poem-one/wrong-file-name.txt')
    blue(result2)
